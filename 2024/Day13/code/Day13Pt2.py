...
def find_prizes_and_tokens(machines):
    ...
    for machine_no in range(len(machines)):
        equation_1 = (machines[machine_no][0][0], machines[machine_no][1][0], machines[machine_no][2][0] + 10_000_000_000_000)
        equation_2 = (machines[machine_no][0][1], machines[machine_no][1][1], machines[machine_no][2][1] + 10_000_000_000_000)
